...
def generateCertificate():
    ...
    subjectInfo=issuer=x509.Name([
        ...
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, u'C919'),
        x509.NameAttribute(NameOID.ORGANIZATIONAL_UNIT_NAME, u'C919'),
        x509.NameAttribute(NameOID.COMMON_NAME, u'pan.c919.com'),
        x509.NameAttribute(ExtensionOID.SUBJECT_ALTERNATIVE_NAME, u'DNS:pan.c919.com'),
    ])
